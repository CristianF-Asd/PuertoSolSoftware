...
public class RegistroVentas extends javax.swing.JInternalFrame {
    ...
    void listar(){
            ...
            ven = ved.VentaxId(ListaVentas.idven);
            idventa =ListaVentas.idven;
            
            List<Pedido> listaped= dao.listarPedidosxIdVent(ListaVentas.idven);
            
            CampoVenta.setText(String.valueOf(ven.getId()));
            CampoVenta.setEditable(false);
            modelo=(DefaultTableModel)TablaProductos.getModel();
            Object[]ob=new Object[6];
            for(int i=0;i<listaped.size();i++){
                CampoMozo.setText(listaped.get(i).getMozo());
                CampoMozo.setEditable(false);
                CampoMesa.setText(med.NoMesa(listaped.get(i).getMesa()));
                CampoMesa.setEditable(false);
                
                
                List<DetallePedido> listadet= dao.listarDetPedidos(listaped.get(i).getId()); 
                for(int j=0;j<listadet.size();j++){
                   ob[0]=j+1;
                   ob[1]=listadet.get(j).getIdProducto();
                   ob[2]=prod.listarID(listadet.get(j).getIdProducto()).getNom();
                   ob[3]=listadet.get(j).getCantidad();
                   ob[4]=prod.listarID(listadet.get(j).getIdProducto()).getPrec();
                   ob[5]=listadet.get(j).getTotal(); 
                   modelo.addRow(ob);
               }
            }
            
            TablaProductos.setModel(modelo);
            CampoTotal.setText(String.valueOf(ven.getPrecioTotal()));
            CampoTotalPagar.setText(String.valueOf(ven.getPrecioTotal()));
            ...
            CampoDescuento.setText(String.valueOf(ven.getDescuento()));
    ...
    void imprimirTicket(){
        try {
            ...
            File archivo;
            archivo = new File("C:\\temp\\ticket"+idventa+".txt");
            ...
            printer.printTextWrap(11, 1, 25, 45, "Nro ticket: "+String.valueOf(idventa));
            printer.printTextWrap(12, 1, 1, 45, "MESERO:"+CampoMozo.getText()); //Aqui va la fecha de recibo
            printer.printTextWrap(13, 1, 1, 45, "MESA:"+CampoMesa.getText()); //Aqui va la hora de recibo
            
            Date dd = ven.getFecha();
            ...
            String sub= printer.alinharADireita(10, String.valueOf(CampoTotal.getText()));
            ...
            printer.toFile("C:\\temp\\ticket"+idventa+".txt");
            FileInputStream inputStream = null;

        try {
            inputStream = new FileInputStream("C:\\temp\\ticket"+idventa+".txt");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CampoMesa, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel9Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(CampoYape)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                                        .addGap(0, 0, Short.MAX_VALUE)
                                        .addComponent(CampoEfectivo, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addComponent(BotonLimpiar, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(29, 29, 29))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    void actualizarPedido(){
       dao.updateCaja(VentasMesa.pe2.getId());
    }
    ...
    void mostarTipoPago(){
        List<TipoPago> listatp= tpd.listarxIdVent(idventa);
